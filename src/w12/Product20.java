...
public class Product20 {
    ...
    public Product20(String name, double price) {
        this.name = name;
        this.price = price;
    }

    public Product20(String name, double price, int quantity) {
        this.name = name;
        this.price = price;
        this.quantity = quantity;
    }

    public Product20(String name, double price, int quantity, String description, boolean isAvailable) {
        this.name = name;
        this.price = price;
        this.quantity = quantity;
...
class Clothing extends Product20{
    private String size;
...
class Electronics extends Product20{
    ...
    public static void main(String[] args) {
        Product20 product1 = new Product20("Product1",10.99);
        Product20 product2 = new Product20("Product2", 20.49, 5);
        Product20 product3 = new Product20("Product3", 5.99,2,"Description for Product 3", true);
...
//        printNonNull("Is Washable", clothing1.isWashable());
